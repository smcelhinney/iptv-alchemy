...
export default function PlayerOverlay({
  ...
  const { available, connected, deviceName, loading, castMedia, disconnect } =
    useChromecast();
    ...
    >
      ...
      >
                ...
                <button
                  onClick={async () => {
                    try {
                      ...
                      setCastingError(
                        error instanceof Error ? error.message : "Failed to cast",
                      );
        ...
        >
          ...
          <span className="text-gray-400 text-xs truncate select-all">
            {streamUrl}
          </span>
          <button
